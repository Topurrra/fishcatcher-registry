...
2. It runs `build-feed.mjs`, which downloads the active phishing-domain list from
   [Phishing.Database](https://github.com/Phishing-Database/Phishing.Database) and packs
   the domains into a Bloom filter.
...
[Phishing.Database](https://github.com/Phishing-Database/Phishing.Database) (MIT).
